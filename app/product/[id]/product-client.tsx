    ...
    <div className="container">
      <nav className="breadcrumb mb-6 hidden sm:block">
        <ol>
          ...
          <li>
            <Link href="/api/products">Каталог</Link>
          </li>
          <li className="breadcrumb-separator">→</li>
      ...
      <div className="product_card">
        ...
        <div className="flex-1">
          <div className="flex flex-col gap-1 mb-[60px]">
            <h2 className="font-bold big text-[var(--color-dark)] mb-2">
              {product.name}
            </h2>
          ...
          <div className="py-6 flex flex-col gap-[20px]">
            ...
            <ul className="space-y-2 text-gray-700">
              <li className="flex flex-row gap-2">
                <div className="text-[var(--color-blue)]">Цвет:</div>{" "}
                {product.color}
              </li>
              ...
              {product.size && (
                <li className="flex flex-row gap-2">
                  <div className="text-[var(--color-blue)]">Размер:</div>{" "}
                  {product.size}
                </li>
              )}
              {product.weightKg && (
                <li className="flex flex-row gap-2">
                  <div className="text-[var(--color-blue)]">Вес:</div>{" "}
                  {product.weightKg}
                </li>
              )}
              {product.retailPriceRubWithVAT !== 0 && (
              ...
              {product.strengthClass && (
                <li className="flex flex-row gap-2">
                  <div className="text-[var(--color-blue)]">Плотность:</div>{" "}
                  {product.strengthClass}
                </li>
              )}
              {product.strengthClass && (
              ...
              {product.heightMm && (
                <li className="flex flex-row gap-2">
                  <div className="text-[var(--color-blue)]">Высота (мм):</div>{" "}
                  {product.heightMm}
                </li>
              )}
              ...
              {product.form && (
                <li className="flex flex-row gap-2">
                  <div className="text-[var(--color-blue)]">Форма:</div>{" "}
                  {product.form}
                </li>
              )}
            </ul>
